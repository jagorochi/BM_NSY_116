...
enum LEVEL_END_EVENT {
  PLAYER_DIE, DOOR_EXITED, TIME_OUT;
}

enum GLC_STATUS {
  TITLE_WAIT, TITLE_LEVEL, LEVEL_PLAY, PLAY_STOP, PLAY_LEVEL, PLAY, PLAY_END,THE_END,END_TITLE;
}
...
enum OBJECT_CATEGORY {
  DEADLY, STATIC, ITEM, BOMB, INTERACTIVE, SWITCH, DEFAULT, EXIT_DOOR, MAGNET, DYNAMITE,SPIKE;
}

enum BIAS_TYPE {
  IN, OUT, BOTH, NONE, ELASTIC, BOUNCE;
}
